...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cuda-toolkit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-toolkit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-toolkit
# for installing globally
pixi global install cuda-toolkit
```
...
It is possible to list all of the versions of `cuda-toolkit` available on your platform:
...
```
pixi search cuda-toolkit --channel conda-forge
```
